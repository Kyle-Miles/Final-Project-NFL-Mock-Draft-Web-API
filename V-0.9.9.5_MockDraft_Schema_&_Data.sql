...
CREATE TABLE user (
	user_pk int unsigned not null auto_increment unique,
...
-- User 
INSERT INTO user (active, password, roles, username) VALUES(True, '$2a$12$0Sl3acfaxa.6yqGbvWFcwu5vTDhq3yzVihot4SS30wlwOFbdz7PNS', 'ROLE_USER', 'user'); 
INSERT INTO user (active, password, roles, username) VALUES(True, '$2a$15$EleZCui9bv3Atxt1fYCcm.lyo5szCJyc36NtdlC2JAlBgkBtDfkxm', 'ROLE_USER,ROLE_ADMIN' , 'admin'); 
